...
Predicting INFY (Infosys) stock prices using a PyTorch LSTM model 
trained on 6 years of historical OHLCV data from Yahoo Finance.

  
**Results on INFY:**
- RMSE: 0.14653778076171875
- MAE:  0.14653778076171875
- MAPE: 1.0312299814801953

**Tech Stack:** Python, PyTorch, yfinance, scikit-learn, matplotlib
